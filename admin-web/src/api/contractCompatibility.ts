...
export type AdminApiContractAssertions = [
  ...
  Assert<Compatible<AdminDashboard, Schema<'AdminDashboardResponse'>>>,
  Assert<Compatible<DashboardStatistics, Schema<'Statistics'>>>,
  Assert<Compatible<DailyRegistration, Schema<'DailyRegistration'>>>,
  Assert<Compatible<RecentRegisteredUser, Schema<'RecentUser'>>>,
  ...
  HasRoute<'/api/v1/admin/dashboard'>,
